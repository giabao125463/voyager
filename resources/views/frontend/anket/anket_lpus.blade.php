...
@section('page_title', '日本語版LupusPRO')
...
<section>
    ...
    <div class="mb-4 text-justify">このアンケートは、SLE または SLEの治療が、あなたの健康、生活の質（QOL）、SLEに関して受けている医療サービスに及ぼす影響について、あなたの見解をたずねるものです。それぞれの質問に対して、<u>一番当てはまるところにチェックマーク　◉　をつけて回答して下さい。</u>もし、質問にどのように答えればよいか迷う場合は、最も近いものを選んで回答して下さい。回答には正解も不正解もありません。1つの質問に対し、１つだけ選んで回答して下さい。”あてはまらない”の箇所がある質問については、これを選択することもできます。
    </div>
...
@endsection
@include('frontend.anket.anket_lpus_script')
